...
<html>
    ...
    <body>
        ...
        <div id="show-planta" class="content scaffold-show" role="main">
            ...
            <g:form resource="${this.planta}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.planta}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
